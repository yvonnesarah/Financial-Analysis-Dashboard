...
let totalMonths = finances.length;
    ...
    document.getElementById("average").textContent = `$${averageChange.toFixed(2)}`;

    const incEl = document.getElementById("increase");
    incEl.textContent = `${greatestIncrease[0]} ($${greatestIncrease[1].toLocaleString()})`;
    incEl.classList.add("positive");

    const decEl = document.getElementById("decrease");
    decEl.textContent = `${greatestDecrease[0]} ($${greatestDecrease[1].toLocaleString()})`;
    decEl.classList.add("negative");